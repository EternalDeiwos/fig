...
export class FHCommonCatalogData {
  ...
  get factoryProductionCategories() {
    return this.factoryProductionData?.extractValues(
      ['Properties'],
      [[
